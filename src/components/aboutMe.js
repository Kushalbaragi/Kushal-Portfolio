...
function AboutMe() {
  return (
    <section id='aboutMe' className="aboutMe-wrapper m-60">
      ...
      <a href="https://www.youtube.com/@KushalBaragi" target='_blank' rel="noreferrer"><button id='unique' className='button-primary'>Checkout Here <img src={send} alt='send-icon'/></button> </a>
    </section>
  );
}
